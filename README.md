...
The lab guide’s **Part 1** opens with a **file reference table** (every artifact and template). **Part 2** includes a short **Knowledge** note on PEM content versus `.crt`/`.pem` filenames for Apache `httpd`.
